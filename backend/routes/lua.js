...
router.get('/load', async (req, res) => {
  ...
  try {
    ...
    let scriptContent = '';
    try {
      const response = await axios.get('https://raw.githubusercontent.com/hyuttgg/lua-/refs/heads/main/khanh.lua', { timeout: 5000 });
      ...
      let scriptPath = path.join(__dirname, '../../core/khanh.lua');
