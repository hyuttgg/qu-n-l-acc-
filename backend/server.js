...
// ══════════════════════════════════════
// PERFORMANCE & SECURITY MIDDLEWARE STACK
// ══════════════════════════════════════
app.use(compression()); // HTTP Response Gzip/Deflate compression
...
async function gracefulShutdown(signal) {
  ...
  try {
    ...
    console.error('Failed to flush telemetry queue on shutdown:', e.message);
  }
