...
module.exports = {
  ...
  findUserByFacebookId: (facebookId) => store.users.find(u => u.facebookId === facebookId),
  createUser: (username, email, password, googleId = null, discordId = null, avatar = null, discriminator = '0', facebookId = null) => {
