        ...
        <div className="flex-1 p-8 bg-slate-950/80">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              ...
              className={`w-full py-4 rounded-xl font-extrabold text-sm text-ocean-abyss bg-gradient-to-r from-gold via-gold-light to-gold shadow-gold-glow hover:opacity-90 transition cursor-pointer flex items-center justify-center gap-2 ${((captchaRequired && !captchaToken) || loading) ? 'opacity-50 cursor-not-allowed' : ''
                }`}
            >
              {loading ? (
