...
export const ReCaptcha = forwardRef<ReCaptchaRef, ReCaptchaProps>(({ siteKey, onChange }, ref) => {
  ...
  useEffect(() => {
    let active = true;
    let timeoutId: any;
    const effectiveSiteKey = (siteKey && siteKey.trim() !== '') ? siteKey.trim() : '6LeIxAcTAAAAAJcZVRqyHh71UMIEGNQ_MXjiZKhI';
    console.log("ReCaptcha effective siteKey is:", effectiveSiteKey);
